        ...
        <div class="box box-solid box-info">
                ...
                <div class="box-body">
                  <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                      ...
                      <thead>
                    <tr role="row">
                        <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 201px;" ><center>ลำดับ
                            </th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 246px;"><center>Object
                            </th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 219px;"><center>สถานะการบันทึกผล
                            </th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 172px;"><center>ผลการประเมิน
                            </th>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-offset-3 col-sm-7">
                      ...
                      <label>
                        <tr> <input type="radio" value="0" name="status_action" id="status_action_1">	 
                            <span class="label label-danger">ยังไม่ดำเนินการ</span></tr> 
                      </label>    
                  </div>
                  <div class="col-sm-offset-3 col-sm-7">
                      <label><tr><input type="radio">  <span class="label label-warning">กำลังดำเนินการ</span></tr></label>
                  </div>
                    <div class="col-sm-offset-3 col-sm-7">
                        <label><tr><input type="radio">  <span class="label label-success">เสร็จสิ้น</span></tr> </label>
                  </div>
                      </div>  
                </div>
                  <div class="form-group">
            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                        <label><tr><input type="radio">  <span class="label label-success">เสร็จสิ้น</span></tr> </label>
                        <label><tr><input type="radio">  <span class="label label-danger">ยังไม่ดำเนินการ</span></tr></label>  
